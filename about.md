...
- make architectural decisions about cloud platforms
- define and promote best practices for development teams
- enable CI/CD pipelines and SaaS services
...
- Long-term SAP implementations for infrastructure and telecom companies
- End-to-end development of cloud applications using **SAPUI5**, **HANA**, and later **SAP BTP**
- Integration-heavy projects connecting on-premise SAP systems with cloud services
...
This blog reflects that mindset:
